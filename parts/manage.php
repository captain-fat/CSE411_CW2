...
echo "<button class='btn' style='float: right' type=\"submit\" name=\"delete\">Delete</button>";
echo "<button class='btn' style='float: right' type=\"submit\" name=\"update\">Update</button>";
echo "<button class='btn' style='float: right' type=\"submit\" name=\"add\">Add</button>";
echo "<table>";
echo "   <tr>";
echo "       <th>ID Num</th>";
echo "       <th>User</th>";
